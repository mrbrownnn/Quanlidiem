  ...
  @endif
      ...
      <form action="{{URL::to('/recover-password')}}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="email" name="email_account" class="form-control" placeholder="Email">
        ...
        <div class="row">
          <div class="col-12">
            <button type="submit" name="recover_password" class="btn btn-primary btn-block">Yêu cầu mật khẩu mới</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
